...
unsafe extern "C" {
    ...
    #[link_name = "\u{1}ffxFsr2ContextGetGpuMemoryUsage"]
    pub fn Fsr2ContextGetGpuMemoryUsage(
        pContext: *mut Fsr2Context,
...
unsafe extern "C" {
    ...
    #[link_name = "\u{1}ffxFsr2GetEffectVersion"]
    pub fn Fsr2GetEffectVersion() -> VersionNumber;
}
unsafe extern "C" {
    ...
    #[link_name = "\u{1}ffxFsr2SetGlobalDebugMessage"]
    pub fn Fsr2SetGlobalDebugMessage(fpMessage: MessageCallback, debugLevel: u32) -> ErrorCode;
}
