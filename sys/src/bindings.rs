...
pub struct Functions {
    ...
    pub s_ViewDescInit: *mut ViewDescription,
    pub AssertReport: unsafe extern "C" fn(
...
impl Functions {
        ...
        L: Into<::libloading::Library>,
    {
        ...
        let s_ViewDescInit = __library
            .get::<*mut ViewDescription>(b"s_FfxViewDescInit\0")
            .map(|sym| *sym)?;
        let AssertReport = __library.get(b"ffxAssertReport\0").map(|sym| *sym)?;
    ...
    pub unsafe fn AssertReport(
        ...
        (self.AssertReport)(file, line, condition, msg)
    }
