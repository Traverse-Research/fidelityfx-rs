...
unsafe extern "C" {
    ...
    #[link_name = "\u{1}ffxFsr1ContextGetGpuMemoryUsage"]
    pub fn Fsr1ContextGetGpuMemoryUsage(
        pContext: *mut Fsr1Context,
...
unsafe extern "C" {
    ...
    #[link_name = "\u{1}ffxFsr1GetEffectVersion"]
    pub fn Fsr1GetEffectVersion() -> VersionNumber;
}
