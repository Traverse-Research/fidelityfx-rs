...
pub const FSR1_VERSION_MINOR: u32 = 2;
...
pub struct Functions {
    ...
    pub Fsr1ContextGetGpuMemoryUsage: unsafe extern "C" fn(
        pContext: *mut Fsr1Context,
    ...
    pub Fsr1GetEffectVersion: unsafe extern "C" fn() -> VersionNumber,
}
impl Functions {
        ...
        L: Into<::libloading::Library>,
    {
        ...
        let Fsr1ContextGetGpuMemoryUsage = __library
            .get(b"ffxFsr1ContextGetGpuMemoryUsage\0")
            .map(|sym| *sym)?;
        ...
        let Fsr1GetRenderResolutionFromQualityMode = __library
            ...
            .map(|sym| *sym)?;
        let Fsr1GetEffectVersion = __library
            .get(b"ffxFsr1GetEffectVersion\0")
            .map(|sym| *sym)?;
        Ok(Functions {
            __library,
            Fsr1ContextCreate,
            Fsr1ContextGetGpuMemoryUsage,
            Fsr1ContextDispatch,
            Fsr1ContextDestroy,
            Fsr1GetUpscaleRatioFromQualityMode,
            Fsr1GetRenderResolutionFromQualityMode,
            Fsr1GetEffectVersion,
        })
    }
    ...
    pub unsafe fn Fsr1ContextGetGpuMemoryUsage(
        &self,
        pContext: *mut Fsr1Context,
        pVramUsage: *mut EffectMemoryUsage,
    ) -> ErrorCode {
        (self.Fsr1ContextGetGpuMemoryUsage)(pContext, pVramUsage)
    }
    ...
    pub unsafe fn Fsr1GetEffectVersion(&self) -> VersionNumber {
        (self.Fsr1GetEffectVersion)()
    }
}
