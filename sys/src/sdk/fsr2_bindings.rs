...
pub const FSR2_VERSION_MINOR: u32 = 3;
pub const FSR2_VERSION_PATCH: u32 = 3;
...
pub struct Functions {
    ...
    pub Fsr2ContextGetGpuMemoryUsage: unsafe extern "C" fn(
        pContext: *mut Fsr2Context,
    ...
    pub Fsr2GetEffectVersion: unsafe extern "C" fn() -> VersionNumber,
    pub Fsr2SetGlobalDebugMessage:
...
impl Functions {
        ...
        L: Into<::libloading::Library>,
    {
        ...
        let Fsr2ContextGetGpuMemoryUsage = __library
            .get(b"ffxFsr2ContextGetGpuMemoryUsage\0")
            .map(|sym| *sym)?;
        ...
        let Fsr2GetEffectVersion = __library
            .get(b"ffxFsr2GetEffectVersion\0")
            .map(|sym| *sym)?;
        let Fsr2SetGlobalDebugMessage = __library
            .get(b"ffxFsr2SetGlobalDebugMessage\0")
            .map(|sym| *sym)?;
        Ok(Functions {
            __library,
            Fsr2ContextCreate,
            Fsr2ContextGetGpuMemoryUsage,
            Fsr2ContextDispatch,
            ...
            Fsr2GetJitterOffset,
            Fsr2ResourceIsNull,
            Fsr2GetEffectVersion,
            Fsr2SetGlobalDebugMessage,
        })
    }
    ...
    pub unsafe fn Fsr2ContextGetGpuMemoryUsage(
        &self,
        pContext: *mut Fsr2Context,
        pVramUsage: *mut EffectMemoryUsage,
    ) -> ErrorCode {
        (self.Fsr2ContextGetGpuMemoryUsage)(pContext, pVramUsage)
    }
    ...
    pub unsafe fn Fsr2GetEffectVersion(&self) -> VersionNumber {
        (self.Fsr2GetEffectVersion)()
    }
    ...
    pub unsafe fn Fsr2SetGlobalDebugMessage(
        &self,
        fpMessage: MessageCallback,
        debugLevel: u32,
    ) -> ErrorCode {
        (self.Fsr2SetGlobalDebugMessage)(fpMessage, debugLevel)
    }
}
