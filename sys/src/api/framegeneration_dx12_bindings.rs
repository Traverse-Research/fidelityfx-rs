...
pub const CREATE_CONTEXT_DESC_TYPE_FRAMEGENERATIONSWAPCHAIN_WRAP_DX12: StructType_t = make_backend_effect_sub_id(BACKEND_ID_DX12, EFFECT_ID_FRAMEGENERATIONSWAPCHAIN, 0x01);
pub const CREATE_CONTEXT_DESC_TYPE_FRAMEGENERATIONSWAPCHAIN_NEW_DX12: StructType_t = make_backend_effect_sub_id(BACKEND_ID_DX12, EFFECT_ID_FRAMEGENERATIONSWAPCHAIN, 0x05);
pub const CREATE_CONTEXT_DESC_TYPE_FRAMEGENERATIONSWAPCHAIN_FOR_HWND_DX12: StructType_t = make_backend_effect_sub_id(BACKEND_ID_DX12, EFFECT_ID_FRAMEGENERATIONSWAPCHAIN, 0x06);
pub const CONFIGURE_DESC_TYPE_FRAMEGENERATIONSWAPCHAIN_REGISTERUIRESOURCE_DX12: StructType_t = make_backend_effect_sub_id(BACKEND_ID_DX12, EFFECT_ID_FRAMEGENERATIONSWAPCHAIN, 0x02);
pub const QUERY_DESC_TYPE_FRAMEGENERATIONSWAPCHAIN_INTERPOLATIONCOMMANDLIST_DX12: StructType_t = make_backend_effect_sub_id(BACKEND_ID_DX12, EFFECT_ID_FRAMEGENERATIONSWAPCHAIN, 0x03);
pub const QUERY_DESC_TYPE_FRAMEGENERATIONSWAPCHAIN_INTERPOLATIONTEXTURE_DX12: StructType_t = make_backend_effect_sub_id(BACKEND_ID_DX12, EFFECT_ID_FRAMEGENERATIONSWAPCHAIN, 0x04);
pub const DISPATCH_DESC_TYPE_FRAMEGENERATIONSWAPCHAIN_WAIT_FOR_PRESENTS_DX12: StructType_t = make_backend_effect_sub_id(BACKEND_ID_DX12, EFFECT_ID_FRAMEGENERATIONSWAPCHAIN, 0x07);
pub const CONFIGURE_DESC_TYPE_FRAMEGENERATIONSWAPCHAIN_KEYVALUE_DX12: StructType_t = make_backend_effect_sub_id(BACKEND_ID_DX12, EFFECT_ID_FRAMEGENERATIONSWAPCHAIN, 0x08);
pub const QUERY_DESC_TYPE_FRAMEGENERATIONSWAPCHAIN_GPU_MEMORY_USAGE_DX12: StructType_t = make_backend_effect_sub_id(BACKEND_ID_DX12, EFFECT_ID_FRAMEGENERATIONSWAPCHAIN, 0x09);
pub const QUERY_DESC_TYPE_FRAMEGENERATIONSWAPCHAIN_GPU_MEMORY_USAGE_DX12_V2: StructType_t = make_backend_effect_sub_id(BACKEND_ID_DX12, EFFECT_ID_FRAMEGENERATIONSWAPCHAIN, 0x0a);
pub const CREATE_CONTEXT_DESC_TYPE_FRAMEGENERATIONSWAPCHAIN_VERSION_DX12: StructType_t = make_backend_effect_sub_id(BACKEND_ID_DX12, EFFECT_ID_FRAMEGENERATIONSWAPCHAIN, 0x0b);
