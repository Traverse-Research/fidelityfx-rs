...
pub const EFFECT_MASK: u32 = 16711680;
pub const BACKEND_MASK: u32 = 4278190080;
...
pub const EFFECT_ID_FRAMEGENERATIONSWAPCHAIN: u32 = 196608;
pub const EFFECT_ID_FRAMEGENERATIONSWAPCHAIN_VK: u32 = 262144;
pub const EFFECT_ID_DENOISER: u32 = 327680;
pub const EFFECT_ID_RADIANCECACHE: u32 = 393216;
pub const BACKEND_ID_DX12: u32 = 0;
pub const BACKEND_ID_XBOX: u32 = 16777216;
pub const BACKEND_ID_VK: u32 = 33554432;
...
impl ReturnCodes {
    ...
    #[doc = "< The structure type given is new and not supported in the old provider. This is likely fixed with driver upgrade or effect DLL upgrade."]
    pub const PROVIDER_NO_SUPPORT_NEW_DESCTYPE: ReturnCodes = ReturnCodes(7);
}
#[repr(transparent)]
...
pub enum SurfaceFormat {
    ...
    R32_TYPELESS = 37,
    #[doc = "< 32 bit per channel, 2 channel uint format"]
    R32G32_UINT = 38,
...
impl ResourceState {
    ...
    pub const DEPTH_ATTACHMENT: ResourceState = ResourceState(512);
}
...
#[doc = " A structure encapsulating a 3-dimensional set of floating point coordinates."]
#[repr(C)]
#[derive(Debug, Default, Copy, Clone)]
pub struct FloatCoords3D {
    #[doc = "< The x coordinate of a 3-dimensional point."]
    pub x: f32,
    #[doc = "< The y coordinate of a 3-dimensional point."]
    pub y: f32,
    #[doc = "< The z coordinate of a 3-dimensional point."]
    pub z: f32,
}
...
impl Default for ConstantBufferAllocation {
    fn default() -> Self {
        let mut s = ::std::mem::MaybeUninit::<Self>::uninit();
        unsafe {
            ::std::ptr::write_bytes(s.as_mut_ptr(), 0, 1);
