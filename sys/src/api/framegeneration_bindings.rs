...
pub const CALLBACK_DESC_TYPE_FRAMEGENERATION_PRESENT: StructType_t =
    MAKE_EFFECT_SUB_ID(EFFECT_ID_FRAMEGENERATION, 0x05);

pub const DISPATCH_DESC_TYPE_FRAMEGENERATION: StructType_t =
    MAKE_EFFECT_SUB_ID(EFFECT_ID_FRAMEGENERATION, 0x03);

pub const CONFIGURE_DESC_TYPE_FRAMEGENERATION: StructType_t =
    MAKE_EFFECT_SUB_ID(EFFECT_ID_FRAMEGENERATION, 0x02);

pub const DISPATCH_DESC_TYPE_FRAMEGENERATION_PREPARE: StructType_t =
    MAKE_EFFECT_SUB_ID(EFFECT_ID_FRAMEGENERATION, 0x04);

pub const CONFIGURE_DESC_TYPE_FRAMEGENERATION_KEYVALUE: StructType_t =
    MAKE_EFFECT_SUB_ID(EFFECT_ID_FRAMEGENERATION, 0x06);

pub const QUERY_DESC_TYPE_FRAMEGENERATION_GPU_MEMORY_USAGE: StructType_t =
    MAKE_EFFECT_SUB_ID(EFFECT_ID_FRAMEGENERATION, 0x07);

pub const CONFIGURE_DESC_TYPE_FRAMEGENERATION_REGISTERDISTORTIONRESOURCE: StructType_t =
    MAKE_EFFECT_SUB_ID(EFFECT_ID_FRAMEGENERATION, 0x08);

pub const CREATE_CONTEXT_DESC_TYPE_FRAMEGENERATION_HUDLESS: StructType_t =
    MAKE_EFFECT_SUB_ID(EFFECT_ID_FRAMEGENERATION, 0x09);

pub const DISPATCH_DESC_TYPE_FRAMEGENERATION_PREPARE_CAMERAINFO: StructType_t =
    MAKE_EFFECT_SUB_ID(EFFECT_ID_FRAMEGENERATION, 0x0a);

pub const QUERY_DESC_TYPE_FRAMEGENERATION_GPU_MEMORY_USAGE_V2: StructType_t =
    MAKE_EFFECT_SUB_ID(EFFECT_ID_FRAMEGENERATION, 0x0b);

pub const DISPATCH_DESC_TYPE_FRAMEGENERATION_PREPARE_V2: StructType_t =
    MAKE_EFFECT_SUB_ID(EFFECT_ID_FRAMEGENERATION, 0x0c);

pub const CALLBACK_DESC_TYPE_FRAMEGENERATION_PRESENT_PREMUL_ALPHA: StructType_t =
    MAKE_EFFECT_SUB_ID(EFFECT_ID_FRAMEGENERATION, 0x0d);

pub const CREATE_CONTEXT_DESC_TYPE_FRAMEGENERATION_VERSION: StructType_t =
    MAKE_EFFECT_SUB_ID(EFFECT_ID_FRAMEGENERATION, 0x0e);

pub const FRAME_GENERATION_CONFIG: StructType_t =
    MAKE_EFFECT_SUB_ID(EFFECT_ID_FRAMEGENERATION, 0x0f);
